...
import (
	...
	"github.com/ekishion/jikeqingpan/internal/app"
	"github.com/ekishion/jikeqingpan/web"
)
...
func main() {
	...
	app.WarnRiskyConfig(cfg)

	srv := app.NewServer(cfg, web.FS, version)
	...
	server := &http.Server{
		...
		WriteTimeout:      app.WriteTimeoutFor(cfg),
